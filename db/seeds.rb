...
Warehouse.create!([
  {name: "warehouse 1", capacity: "20.0", "address_attributes": {street: "calle san juan de la cruz", street_number: "34", additional_information: "6", zipcode: "28016", town: "Madrid", state: "Madrid",country: "España"}},
  {name: "warehouse 2", capacity: "0.1", "address_attributes": {street: "calle del carmen", street_number: "44", additional_information: "5b", zipcode: "28006", town: "Madrid", state: "Madrid",country: "España"}}
])
Supplier.create!([
